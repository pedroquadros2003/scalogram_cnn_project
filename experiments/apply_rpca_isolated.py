...
parser = argparse.ArgumentParser(description="Apply RPCA Isolated Preprocessing to a Folder")
...
parser.add_argument("--output_folder", type=str, default="isolated_scalograms", help="Output folder name inside OUTPUT_DIR")
