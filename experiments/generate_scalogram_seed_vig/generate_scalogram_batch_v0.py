...
from scalogram_cnn_project.scalogram_generation_seed_vig.generator_scalogram_batch import (
    generate_scalogram
)
...
CHANNELS = ['FT8'] #['FT8','T7','T8','TP7','TP8','CP1','CP2','P1','PZ','P2','PO3','POZ','PO4','O1','OZ','O2']
...
if __name__ == "__main__":
    ...
    # Delete samples file from before
